...
from .resnet_MD import Bottleneck as _Bottleneck
from .resnet_MD import ResNet_MD #ResNetV1d_MD,
...
class ResNeSt_MD(ResNet_MD):
    ...
    def __init__(self,
        ...
        super(ResNeSt_MD, self).__init__(**kwargs)

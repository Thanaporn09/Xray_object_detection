...
from .cascade_roi_head_point import CascadeRoIHead_point
...
from .standard_point_roi_head import StandardRoIHead_point
...
__all__ = [
    ...
    'FeatureRelayHead', 'GlobalContextHead','StandardRoIHead_point','CascadeRoIHead_point'
]
